---
title: "Differential Gene Expression Analysis- Cervical Cancer (Stage 3)"
...
## Downloading the TCGA cervical cancer data (CESC)
```{r}
...
## Extracting Tumor and Normal Sample Barcodes:
```{r}
...
### Sample tumour samples by age

## Selecting number of samples for DEA and ML
